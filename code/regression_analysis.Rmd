...
- finally, we chose the original or raw scale of "num_terms" and "monthly_tweets" based on AIC (the one with the smallest AIC)
...
```{r}
plot_model(model_overall, show.values = TRUE, value.offset = .4)
```
...
mylist <- list('avg_age'=5, 'followers_log'=.5, 'avg_num_terms'=1, 'avg_monthly_tweets'=20)
...
data$daily_tweets = data$monthly_tweets/30
data$age10 = data$age/10

factors = "gender + party + chamber + age10 + num_terms + daily_tweets + followers_log"
